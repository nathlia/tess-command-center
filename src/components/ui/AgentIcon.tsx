...
import type { AgentIcon as IconType } from '../../types/agent'
...
export function AgentIcon({ icon, size = 14, className = '' }: Props) {
  return (
    <span
      className={`inline-flex items-center justify-center shrink-0 ${className}`}
      style={{ width: size, height: size, color: 'var(--text-ink)' }}
      aria-hidden="true"
    >
      {icons[icon]}
    </span>
